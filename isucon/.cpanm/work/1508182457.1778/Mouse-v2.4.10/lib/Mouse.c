...
XS_EUPXS(XS_Mouse__Meta__Module_namespace)
{
	...
	SV*	self = ST(0)
;
#line 485 "lib/Mouse.xs"
{
    RETVAL = mouse_get_namespace(aTHX_ self);
}
#line 624 "lib/Mouse.c"
	{
	    SV * RETVALSV;
